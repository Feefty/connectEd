        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
					...
					<div id="toolbar">
                    	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addAchievementModal">Add Achievement</button>
					</div>
                    		...
                    		<table data-toggle="table" data-url="{{ action('Admin\AchievementController@getAPI') }}" data-pagination="true" data-search="true" data-show-refresh="true" data-toolbar="#toolbar">
                    			<thead>
                    				<tr>
                    					...
                    					<th data-formatter="actionAchievementFormatter" data-align="center">Actions</th>
                    				</tr>
                    			</thead>
                    		</table>
                    	</div>
